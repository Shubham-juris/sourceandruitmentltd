    ...
    <div className="bg-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-bold text-orange-500 mb-6">Featured Job Listings Section</h2>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8">
          ...
          <div className="lg:w-3/5">
            <h3 className="text-3xl lg:text-4xl font-semibold text-orange-500 mb-8">Administrative Job Opportunities:</h3>
            
            <ul className="space-y-6">
              <li className="flex items-start">
                <span className="text-orange-500 text-3xl mr-2">•</span>
                <div>
                  <span className="text-xl lg:text-2xl font-semibold text-gray-800">Administrative Assistant:</span>
              ...
              <li className="flex items-start">
                <span className="text-orange-500 text-3xl mr-2">•</span>
                <div>
                  <span className=" text-xl lg:text-2xl font-semibold text-gray-800">Bookkeeper:</span>
              ...
              <li className="flex items-start">
                <span className="text-orange-500 text-3xl mr-2">•</span>
                <div>
                  <span className=" text-xl lg:text-2xl font-semibold text-gray-800">Office Clerk:</span>
              ...
              <li className="flex items-start">
                <span className="text-orange-500 text-3xl mr-2">•</span>
                <div>
                  <span className=" text-xl lg:text-2xlfont-semibold text-gray-800">Receptionist:</span>
              ...
              <li className="flex items-start">
                <span className="text-orange-500 text-3xl mr-2">•</span>
                <div>
                  <span className=" text-xl lg:text-2xl font-semibold text-gray-800">Data Entry Clerk:</span>
              ...
              <li className="flex items-start">
                <span className="text-orange-500 text-3xl mr-2">•</span>
                <div>
                  <span className=" text-xl lg:text-2xlfont-semibold text-gray-800">Executive Assistant:</span>
