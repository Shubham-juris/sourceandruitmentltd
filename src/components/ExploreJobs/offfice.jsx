...
export default function JobApplicationFormmmm() {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-20 p-6 font-sans">
      <h1 className="text-4xl font-normal text-center text-orange-500 mb-3">Office Clerk</h1>
      <div className="border-t border-gray-300 w-32 mx-auto mb-8"></div>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2">
          ...
          <ul className="list-disc pl-5 mb-6 space-y-2 text-gray-700">
            ...
            <li>Provide clerical support such as filing, photocopying, organizing documents, preparation of letters, maintaining of databases.</li>
        ...
        <div className="md:w-1/2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button 
              type="submit" 
              className="w-full bg-orange-500 text-white py-4 rounded-md font-semibold hover:bg-orange-600 transition-colors"
            >
              SUBMIT APPLICATION
            </button>
